...
urls = {
    "Математика": {
        "ММО": {
            ...
            "Информация": ("Московская Математическая Олимпиада (ММО)"
                           " - олимпиада по математике, "
                           "имеющая первый уровень,"
                           " что может дать БВИ или полные 100 баллов,"
                           " во многие ВУЗы."
                           "Состоит из 2 этапов: Отборочный, Заключительный. "
                           "Больше можно узнать на сайте или в материалах.")
        },
        "ВОШ": {
